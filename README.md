...
### **Vídeo de Demostración**
📹 **[Enlace al vídeo en YouTube](https://youtu.be/clarNj2NjKk)**
> Vídeo mostrando las principales funcionalidades de la aplicación web.
...
#### **Documentación HTML**
📖 **[Documentación API REST (HTML)](https://raw.githack.com/CodeURJC-DAW-2025-26/practica-daw-2025-26-grupo-7/main/api-docs/api-docs.html)**
...
![Diagrama de Clases Actualizado](backend/src/main/resources/static/img/DiagramaEntrega2.png)
